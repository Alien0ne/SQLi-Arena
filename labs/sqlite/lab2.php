...
if (isset($_POST['flag'])) {
    ...
    if ($res && $submitted === $res) {
        ...
        header("Location: " . url_lab_from_slug("sqlite/lab2", $mode, $_GET['ref'] ?? ''));
        exit;
    } else {
...
<div class="card">
    ...
    <h4>Scenario</h4>
    <p>
        A company employee directory lets you search for employees by name to find their department.
    </p>
