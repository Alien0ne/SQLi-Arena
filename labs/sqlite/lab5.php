...
if (isset($_POST['flag_field'])) {
    ...
    if ($res && $submitted === $res) {
        ...
        header("Location: " . url_lab_from_slug("sqlite/lab5", $mode));
        exit;
    } else {
...
<div class="card">
    ...
    <h4>Scenario</h4>
    <p>
        This is a session token validator. Enter a token and the system will check if it exists.
        The response is always the same regardless of the input: "Token checked."
    </p>
