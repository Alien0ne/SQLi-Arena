...
if (isset($_POST['admin_password'])) {
    ...
    if ($row && $submitted === $row['key_value']) {
        ...
        header("Location: " . url_lab_from_slug("mariadb/lab3", $mode));
        exit;
    } else {
...
<!-- Verify Flag -->
<div class="card">
    <h4>Submit Federation Key</h4>
    <form method="POST" class="form-row">
        <input type="text" name="admin_password" class="input" placeholder="Enter the federation key (flag)..." required>
