...
if (isset($_POST['admin_password'])) {
    ...
    if ($row && $submitted === $row['vault_key']) {
        ...
        header("Location: " . url_lab_from_slug("mariadb/lab5", $mode));
        exit;
    } else {
...
<!-- Verify Flag -->
<div class="card">
    <h4>Submit Vault Key</h4>
    <form method="POST" class="form-row">
        <input type="text" name="admin_password" class="input" placeholder="Enter the vault key (flag)..." required>
