...
if (isset($_POST['flag_field'])) {
    ...
    if ($submitted === 'FLAG{gq_1ntr0sp3ct_sch3m4}') {
        ...
        header("Location: " . url_lab_from_slug("graphql/lab1", $mode));
        exit;
    } else {
...
<div class="card">
    ...
    <h4>Scenario</h4>
    <p>
        The Product API exposes a GraphQL endpoint. The API serves user and product data.
...
<div class="card">
    ...
    <form method="POST" action="?lab=graphql/lab1&mode=<?= htmlspecialchars($mode) ?>&execute=1">
