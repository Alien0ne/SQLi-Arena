...
-- Double-Quote String Injection
-- =========================

CREATE DATABASE IF NOT EXISTS sqli_arena_mysql_lab4;
...
('DRAFT: Internal Security Audit',  'editor',   'This article contains confidential findings from the Q1 audit...','FLAG{my_d0ubl3_qu0t3_1nj}');
